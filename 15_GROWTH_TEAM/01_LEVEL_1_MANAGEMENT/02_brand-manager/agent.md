...
4. `CLAUDE.md`
5. `01_BRAND/**`, `02_COMPANY/**`

## Verantwortungsbereich

- Primärdateien/Ordner: `01_BRAND/**`, `02_COMPANY/**`
- Trägt bei zu: Content Team, Social Media Team, SEO Team (Konsistenz von Marke/Tonalität)
...
- Autonomiestufe (Regelfall): GRÜN/GELB je nach Thema — siehe `12_AI_SYSTEM/03_github-autonomy.md`
