...
4. `CLAUDE.md`
5. `09_CONTENT_ENGINE/**`, `04_AUDIENCE/**` (als Input)

## Verantwortungsbereich

- Primärdateien/Ordner: `09_CONTENT_ENGINE/**`, `04_AUDIENCE/**` (als Input)
- Trägt bei zu: SEO Team, Social Media Team
...
- Autonomiestufe (Regelfall): GRÜN — siehe `12_AI_SYSTEM/03_github-autonomy.md`
